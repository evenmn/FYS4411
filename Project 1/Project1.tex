...
\begin{figure} [H]
    ...
    \caption{The onebody density of the bosonic system, which is run with $\alpha=0.5$ for $a=0$ and compared with the analytical expression. The optimal $\alpha$ for the interacting case with $a=0.0043$ was found to be $\alpha = 0.3450$. As length is dimensionless, both the density $\rho$ and the length $r$ are dimensionless.}
    \label{fig:ob0}
\end{figure}
