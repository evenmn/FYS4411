...
\begin{figure} [H]
    ...
    \caption{The one body density of the bosonic system, with $a=0$ and the optimal variational parameter $\alpha = 0.34502$. As lenght is dimentionless, both the density $\rho$ and the length $r$ are dimentionless}
    \label{fig:ob00043}
\end{figure} 
...
\begin{figure} [H]
    ...
    \caption{\textcolor{red}{The one body density of the bosonic system, with $a=0$ and the optimal variational parameter $\alpha =$. As lenght is dimentionless, both the density $\rho$ and the length $r$ are dimentionless}}
    \label{fig:ob1}
\end{figure} 
