...
With interaction we got reasonable results for one and ten particles, but for 100 particles the energies were probably higher than they should be. The optimal variational parameter $\alpha$ did not match the optimal $alpha$ gotten from gradient descent, and perhaps we have a bug in the code which appears for a large number of particles. 
