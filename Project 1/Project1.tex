...
and $V_{int}$ as the interaction term. The interaction will in the first place be ignored, and will be given later.
...
E_L(x) &=  \frac{1}{\Psi_T(x)}\hat{H}\Psi_T(x) \\ 
			 ...
			 & = e^{\alpha x^2} [-\frac{\hbar^2}{2m}\frac{\partial^2 }{\partial x^2} (e^{-\alpha x^2}) + \frac{1}{2} m \omega_{HO}^2 x^2 ()e^{-\alpha x^2})]
\end{aligned}
\end{equation}
