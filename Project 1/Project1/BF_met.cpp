...
void Met_algo(int N, int dim, int M, double a, double steplength, double omega_HO, double omega_z, int HO, double alpha[], int length_alpha_1, double beta, double h)
{
