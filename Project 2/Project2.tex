...
For one particle in one dimension, we found the brute-force Metropolis algorithm and the Metropolis-Hastings algorithm to be more accurate compared to Gibbs' sampling. The reason for that is probably related to how we define the wave function. Since the wave function used in Gibbs' sampling is the square root of the porbability distribution, this is farer from the true wave function. 
