...
The results for changing the learning rate and number of hidden nodes discussed above are run for the non-interacting case with the brute force Metropolis algorithm. As shown in figure \ref{fig:energy_compare_eta_2P} and \ref{fig:}, the interacting case yielded the same results. 
\par
\vspace{3mm}
