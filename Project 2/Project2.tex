...
Again we play with the number of nodes and the learning rate
 ...
 \begin{figure} [H]
 	...
 	\label{fig:fig:energy_compare_nodes_2P}
 \end{figure}
 ...
 \begin{figure} [H]
 	...
 	\label{fig:fig:energy_compare_eta_2P}
 \end{figure}
...
\subsubsection{Changing learning rate and number of hidden nodes}
 \begin{figure} [H]
 	...
 	\label{fig:fig:energy_compare_nodes_2P_gibbs}
 \end{figure}
  ...
  \begin{figure} [H]
 	...
 	\label{fig:fig:energy_compare_eta_2P_gibbs}
 \end{figure}
...
\subsubsection{Changing the sampling width $\sigma$ used in Gibbs}
  \begin{figure} [H]
 	...
 	\label{fig:fig:energy_compare_sigma_2P_gibbs}
 \end{figure}
...
\par 
\vspace{3mm}
We varied the number of hidden nodes $N$ used in the machine learning program, as seen in figure \ref{fig:compare_nodes}. We see that varying the number of hidden nodes changes the rapidness of the method's convergence. For few hidden nodes, the convergence of the energy seems to happen slower, while for many hidden nodes, it descends steeply towards the analytical energy. This can maybe be explained by when there are more free parameters that can be varied, the optimalization occurs faster. \par 
We also see that we get better estimates of the ground state energy when using fewer hidden nodes. This is as expected, since more hidden nodes means more variables that has to be updated for each cycle, and thus a less precise answer. However, this is one of the drawback pf machine learning; there are many choices of different numbers of paramteres, and it is difficult to choose these parameters such that one gets optimal results.
\par 
\vspace{3mm}
...
The results for changing the learning rate and number of hidden nodes discussed above are run for the interacting case with the brute force Metropolis algorithm. As shown in figure \ref{fig:energy_compare_eta_2P} and \ref{fig:}, the interacting case yielded the same results. \textcolor{red}{$\rightarrow$ Need to extend this}
\par
\vspace{3mm}
