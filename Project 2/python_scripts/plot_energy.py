...
'''
data1 = np.loadtxt("../data/BF_1P_N_1_MC_2pow20_eta_001.txt")
data2 = np.loadtxt("../data/H_1P_N_1_MC_2pow20_eta_001.txt")
data3 = np.loadtxt("../data/G_1P_N_1_MC_2pow20_eta_001.txt")
...
plt.plot(x1, data1, label="BF")
plt.plot(x2, data2, label="H")
plt.plot(x3, data3, label="G")
